...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      <div className="h-screen/2 bg-ocean flex flex-col">
        <Navigation />
        ...
        <section className="  flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 w-full">
          <div className="space-y-6 animate-slide-up">
            ...
            <p className="text-pretty text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Professional design, development, and training services for
              startups, SMEs, enterprises, and individuals seeking excellence.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-background rounded-lg p-8 border border-border hover:border-secondary hover:shadow-lg transition-all duration-300 animate-slide-up hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Stunning visual designs that communicate your brand message and
                captivate your audience with professional aesthetics.
              </p>
            </div>
            ...
            <div className="bg-background rounded-lg p-8 border border-border hover:border-secondary hover:shadow-lg transition-all duration-300 animate-slide-up hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Custom coding and WordPress solutions that deliver fast,
                responsive, and scalable web experiences for your business.
              </p>
            </div>
            ...
            <div className="bg-background rounded-lg p-8 border border-border hover:border-secondary hover:shadow-lg transition-all duration-300 animate-slide-up hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Comprehensive courses and mentorship to upskill your team in
                design, development, and digital transformation.
              </p>
            </div>
          </div>
